...
These JSON files describe how a wallet should render PragueConnect's contract calls
...
|---|---|---|
| `PragueConnectTip.json` | One-shot stealth gift | `0x44b09471Ece57443FE5b9d350eF3B4f90244AB1b` |
| `PragueConnectEscrow.json` | Four-phase Magnum Opus escrow | `0xcec992ABAfA04cD2F0c89BFAa93bdae3bF9da67F` |
...
The sender now knows exactly what they're signing. For PragueConnect's
...
Once PragueConnect is on mainnet (post-hackathon), these files belong in the
